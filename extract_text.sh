#!/bin/bash
BPATH=/Users/avinashraj/Desktop/Project/resume/  # Path to directory containing PDFs.
OPATH=/Users/avinashraj/Desktop/Project/textresume/ # Path to output directory.
LANG=eng  # See man tesseract > LANGUAGES
MIN_WORDS=25     # Number of words required to accept pdftotext result.
